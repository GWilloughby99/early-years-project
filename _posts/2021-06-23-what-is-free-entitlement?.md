...
<br>
<audio controls src="{{ "/assets/audio/free-entitlement.mp3" | relative_url }}"> </audio>
<hr>
...
<img src="{{ "/assets/article_images/fence.jpg" | relative_url }}" alt="The 30 hours of entitlement requires additional funding to cover the cost and also settings need to ensure they have a sufficient number of available employees to staff it. Picture source: Pixabay.">
...
<img src="{{ "/assets/article_images/childcare-application.png" | relative_url }}" alt="This website is where parents can apply for entitlement. Screengrab took from the official government website. Access the website via: https://www.gov.uk/apply-30-hours-free-childcare">
<hr>
